...
void RestfulapiControllerBase::getOne(const HttpRequestPtr &req,
...
void RestfulapiControllerBase::updateOne(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback,
                                         Users::PrimaryKeyType &&id)
{
...
void RestfulapiControllerBase::deleteOne(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback,
                                         Users::PrimaryKeyType &&id)
{
...
void RestfulapiControllerBase::get(const HttpRequestPtr &req,
                                   std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Users> mapper(dbClientPtr);
...
void RestfulapiControllerBase::create(const HttpRequestPtr &req,
                                      std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
...
/*
void RestfulapiControllerBase::update(const HttpRequestPtr &req,
                                      std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

RestfulapiControllerBase::RestfulapiControllerBase()
    : RestfulController({
          "id",
          "username",
          "email",
